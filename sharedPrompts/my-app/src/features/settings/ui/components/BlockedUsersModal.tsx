...
import { FOLLOW_ERROR_MESSAGES } from '@/features/follow/constants/follow.constants';
import { extractErrorMessage } from '@/features/follow/utils/error.utils';
...
function BlockedUserItem({ user, onUnblock, isLoading }: BlockedUserItemProps) {
  ...
  return (
    <div className="flex flex-col gap-2 p-4 bg-neutral-50 rounded-xl hover:bg-neutral-100 transition-colors">
