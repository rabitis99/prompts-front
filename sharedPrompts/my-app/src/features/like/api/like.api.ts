...
export const likeApi = {
  ...
  likePrompt: (promptId: number) =>
    api.post<CustomResponse<PromptLikeResponseDto>>(`/prompts/${promptId}/likes`),

  // 프롬프트 좋아요 취소
  unlikePrompt: (promptId: number) =>
    api.delete<CustomResponse<PromptLikeResponseDto>>(`/prompts/${promptId}/likes`),
  ...
  likeComment: (commentId: number) =>
    api.post<CustomResponse<CommentLikeResponseDto>>(`/comments/${commentId}/likes`),

  // 댓글 좋아요 취소
  unlikeComment: (commentId: number) =>
    api.delete<CustomResponse<CommentLikeResponseDto>>(`/comments/${commentId}/likes`),
